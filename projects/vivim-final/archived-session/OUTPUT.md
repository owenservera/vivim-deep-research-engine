...
## Framework reference (added 2026-08-24)
This audit output (project/OUTPUT.md) is derived from rchive/original-ideation/AUDIT_OUTPUT-2026-08-24.md. The framework formalization (DESIGN.md, ramework.json) preserves this output but does not approve it for production. See OWNER.md § What I do NOT own.
